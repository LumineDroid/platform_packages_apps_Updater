 ...
 */
package org.luminedroid.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_ALLOW_MAJOR_UPGRADES = "luminedroid.updater.allow_major_upgrades";
    public static final String PROP_BUILD_DATE = "ro.build.date.utc";
    public static final String PROP_BUILD_VERSION = "org.lumine.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "org.lumine.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "org.lumine.build.type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "luminedroid.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "luminedroid.updater.uri";
